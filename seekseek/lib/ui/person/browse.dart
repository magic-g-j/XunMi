...
class _BrowsePageState extends State<BrowsePage> {
  ...
  getPosts() async {
    var responseBody;
    var url = 'http://101.132.157.72:8084/history/list?userId='+MyApp.userId.toString();
...
//                            学科
                            child: Text(posts[i]['historyTitle'].toString(),
                                style: new TextStyle(
...
//                            标题
                                child: Text(posts[i]['historySubjectName'].toString(),
                                    style: new TextStyle(
                                        fontSize: 12, color: Colors.grey)),
                              ),
                              Text(posts[i]['historyCtime'].toString().split('T')[0],
                                  style: new TextStyle(
                                      fontSize: 12, color: Colors.grey)),
                            ],
                          ),
